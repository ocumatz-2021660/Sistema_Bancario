      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <p className="text-text-secondary font-medium mt-2">
            Paga tus facturas y canjea beneficios institucionales.
          </p>
        </div>
      ...
      {serviceLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service) => (
            <div
              key={service._id}
              className="bank-card group hover:border-primary transition-all duration-300 flex flex-col justify-between"
            >
              <div>
              ...
              <div className="pt-6 border-t border-border flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl font-black text-primary tracking-tighter">
                    pt {service.puntos_requeridos || 0}
                  </p>
                </div>
                <button
            ...
            <div className="p-8 space-y-8">
              <div className="flex items-center justify-between p-4 bg-background rounded-2xl border border-border">
                ...
                <span className="text-xl font-black text-primary tracking-tighter">
                  pt {selectedService?.puntos_requeridos}
                </span>
              </div>
                  ...
                  {accounts.map((account) => (
                    ...
                    >
                      ...
                      <p className="text-xs font-black text-text-primary">
                        pt {account.puntos_cuenta?.toLocaleString() || '0'}
                      </p>
                    </label>
                  ))}
                </div>
              ...
              <div className="bg-amber-50 p-4 rounded-xl border border-amber-100 flex gap-3">
                ...
                <p className="text-[10px] text-amber-700 font-medium leading-relaxed">
                  Esta operación descontará el monto indicado de su saldo
                  disponible. No hay reversiones automáticas.
                </p>
              </div>
